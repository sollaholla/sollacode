...
import {
  ...
  type PromoteQueuedThreadTurnsInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    promoteQueuedTurns: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:promote-queued-turns",
      execute: (input: PromoteQueuedThreadTurnsInput) => promoteQueuedThreadTurns(input),
      scheduler,
      concurrency: threadControlCommandConcurrency,
    }),
