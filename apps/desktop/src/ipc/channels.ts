...
export const RECONCILE_TAILSCALE_SERVE_CHANNEL = "desktop:reconcile-tailscale-serve";
export const GET_ADVERTISED_ENDPOINTS_CHANNEL = "desktop:get-advertised-endpoints";
export const LIST_LAN_PEERS_CHANNEL = "desktop:list-lan-peers";
export const GET_LAN_DISCOVERY_STATE_CHANNEL = "desktop:get-lan-discovery-state";
export const REQUEST_LAN_PAIRING_CHANNEL = "desktop:request-lan-pairing";
export const COMPLETE_LAN_PAIRING_CHANNEL = "desktop:complete-lan-pairing";
export const LAN_PAIRING_EVENT_CHANNEL = "desktop:lan-pairing-event";
...
export const PREVIEW_SET_DOWNLOAD_DIRECTORY_CHANNEL = "desktop:preview-set-download-directory";
...
export const PREVIEW_FORGET_DOWNLOAD_DOMAINS_CHANNEL = "desktop:preview-forget-download-domains";
...
export const PREVIEW_AUTOMATION_RENEW_FOREGROUND_CHANNEL =
