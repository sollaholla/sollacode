...
export const AGENT_BUILDER_WELCOME = [
  "This is the Agent Builder — describe an agent in one message and it gets designed and created end to end: a named worker with a dedicated chat (sharing the environment's browser logins), scheduled tasks, notification preferences, and a structured artifact when it needs a dashboard.",
  "",
