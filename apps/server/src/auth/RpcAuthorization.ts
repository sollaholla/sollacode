...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.voiceTranscriptCorrect]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.serverStartHostRepair]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.projectsCheckWorkspaceRoot]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.previewRemoteSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.previewRemoteInput]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewRemotePick]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.vmAgentRulesUpdate]: AuthVmOperateScope,
  [WS_METHODS.vmAgentAttentionSubscribe]: AuthVmOperateScope,
  ...
  [WS_METHODS.vmAgentNotificationUpdate]: AuthVmOperateScope,
