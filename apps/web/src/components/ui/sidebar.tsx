...
function SidebarMenuAction({
  ...
  const defaultProps = {
    className: cn(
      ...
      "group-data-[collapsible=icon]:hidden",
      showOnHover &&
        "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-foreground md:opacity-0 md:pointer-coarse:opacity-100",
      className,
    ),
