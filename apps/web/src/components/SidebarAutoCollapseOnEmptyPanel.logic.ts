/**
 * Whether closing the last right-panel tab should also fold the sidebar away.
 *
 ...
 */
export function shouldAutoCollapseOnEmptyPanel(input: {
  ...
  if (!input.sidebarVisible) return false;
