...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it.effect("signs macOS builds with Electron entitlements and no removed Clerk provisioning", () =>
    Effect.gen(function* () {
      ...
      assert.include(MAC_ENTITLEMENTS, "com.apple.security.cs.allow-jit");
      assert.include(MAC_ENTITLEMENTS, "com.apple.security.device.audio-input");
      assert.notInclude(MAC_ENTITLEMENTS, "associated-domains");
