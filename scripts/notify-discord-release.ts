  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Solla Code prerelease is available for nightly testers."
          : "A new Solla Code latest release is available.",
...
).pipe(Command.withDescription("Post a Solla Code release announcement to Discord."));
